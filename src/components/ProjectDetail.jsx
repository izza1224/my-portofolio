...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/izza",
      };
  ...
  const projectUrl = `https://izza.com/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Ek Zulfar Rachman</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh izza baghuz syafi'i ma'arif — teknologi rekayasa komputer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — izza baghuz syafi'i ma'arif`}
        />
        <meta
